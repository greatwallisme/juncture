...
没有 [LangGraph](https://github.com/langchain-ai/langgraph) 就没有这个项目。Juncture 的编程模型、执行语义和 API 设计均源自 LangGraph 的架构。我们衷心感谢 LangChain 团队在图驱动智能体编排方面的开创性工作。

在开发过程中，我们还学习和参考了 Rust 社区中同类项目的实践经验：
...
### 可观测性 (juncture-tracing)

- OpenTelemetry 集成，支持节点级 span
- Token 使用量指标
